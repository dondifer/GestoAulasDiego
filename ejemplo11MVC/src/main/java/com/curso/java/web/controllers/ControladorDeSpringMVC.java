...
public class ControladorDeSpringMVC {
	...
	public ModelAndView miraMensajeChulo(@RequestParam("nombre") String nombre, HttpServletRequest request) {
		...
		modelAndView.addObject("mensajeChulo",mensajeChulo); //Devolver los datos al model and view
